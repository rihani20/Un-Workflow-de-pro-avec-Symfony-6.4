...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, ToyRequest>
     */
    #[ORM\OneToMany(targetEntity: ToyRequest::class, mappedBy: 'user')]
    private Collection $toyRequests;
    ...
    /**
     * @return Collection<int, ToyRequest>
     */
    ...
    public function addToyRequest(ToyRequest $toyRequest): static
    {
        if (!$this->toyRequests->contains($toyRequest)) {
            $this->toyRequests->add($toyRequest);
    ...
    public function removeToyRequest(ToyRequest $toyRequest): static
    {
